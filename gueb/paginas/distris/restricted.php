            ...
            <table width="100%"  border="0">
              <tr>
                <td height="95" valign="top"><div align="center">
                    <p>&nbsp;</p>
                    <p>Zona de acceso solo para distribuidores y tiendas </p>
                    <p>
                <form action="validationpages/check.php" name="Formulario_3" id="Formulario_3"  onSubmit="return validarDatos_3()" >
				<div align="center">
				<p><font face="Arial, Helvetica, sans-serif"><strong>Validese con su usuario <br> 
				  email 
                    ...
                    <p><font face="Arial, Helvetica, sans-serif"><a href="validationpages/forgetPwd.php">Olvido su clave ? ! ? </a><BR>
                    <a href="validationpages/registrar.php">Nuevo Usuario</a></font></p>
