...
$result=mysql_query("select * from Clientes_Tiendas where email = '". $hd_usr ."'" ,$link); 
...
//$bar = str_replace ( "%%slash%%", "/", $hd_adr )
		...
		$result=mysql_query("INSERT INTO Datas_Tiendas (mail,otro) VALUES('" . $hd_usr . "','" . $hd_pwd . "')",$link);
	
		$usr=$hd_usr;

		$result=mysql_query("INSERT INTO Clientes_Tiendas (email,Nombre,Apellido1,Telefono,Apellido2,Doc,Empresa,Direccion,Poblacion,Provincia,Pais,Cp,L_Promos,L_Recarga) VALUES('" . $hd_usr . "','" . $hd_nom . "','" . $hd_ape1 . "','" . $hd_tel . "','" . $hd_ape2 . "','" . $hd_doc . "','" . $hd_empresa . "','" . $hd_adr . "','" . $hd_pob . "','" . $hd_prov . "','" . $hd_pais . "','" . $hd_cp . "','','')",$link);
...
$distri = "";
// Para saber si es tienda o distribuidor
