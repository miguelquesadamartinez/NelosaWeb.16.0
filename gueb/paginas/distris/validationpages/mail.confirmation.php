  ...
  <table width="745" border="0" cellpadding="0" cellspacing="0">
    <tr>
      <td height="13" bgcolor="#FFFFFF"><div align="center">
          <p>&nbsp;</p>
          <p>Su solicitud sera atendida en breve </p>
          <p>
		  <?php 
$emilio=$hi_usr;
...
$usr = str_replace ( " ", "%20", $hd_usr );
$pwd = str_replace ( " ", "%20", $hd_pwd );
$nom = str_replace ( " ", "%20", $hd_nom );
$ape1 = str_replace ( " ", "%20", $hd_ape1 );
$tel = str_replace ( " ", "%20", $hd_tel );
$ape2 = str_replace ( " ", "%20", $hd_ape2 );
$doc = str_replace ( " ", "%20", $hd_doc );
$empresa = str_replace ( " ", "%20", $hd_empresa );
$cp = str_replace ( " ", "%20", $hd_cp );
$pob = str_replace ( " ", "%20", $hd_pob );
$pais = str_replace ( " ", "%20", $hd_pais );
$prov = str_replace ( " ", "%20", $hd_prov );
$adr = str_replace ( " ", "%20", $hd_adr );
//echo "<BR>bar: " . $bar ."<BR>";
$text =  "Pincha en el link\npara aceptar la creacion del usuario\n\n" ;
$text = $text . "usuario=" . $usr . "\npwd=" . $pwd . "\nnom=" . $nom . "\nape1=" . $ape1 . "\ntel=" . $tel . "\nape2=" .
  $ape2 .  "\ndoc=" . $doc ."\nempresa=" . $empresa . "\ncp=" . $cp . "\npob=" . $pob . "\npais=" .  $pais . "\nprov=" . $prov . "\nadr=" . $adr  ;
$text = $text . "\nhttp://www.nelosa.net/gueb/paginas/distris/validationpages/doneUser.php?hd_usr=" .
