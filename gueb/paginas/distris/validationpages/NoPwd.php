          ...
          <table width="100%"  border="0">
            <tr>
              <td height="95" valign="top"><div align="center">
                <p align="center"><strong><font color="#FF0000" size="5" face="Arial, Helvetica, sans-serif">La contrase&ntilde;a no coincide ! !</font></strong></p>
                <form action="registrar.php" name="Formulario_3" id="Formulario_3" method="post" >
                  <div align="center">
                    <table border="0" width="95%">
                      <tr bgcolor="#FFFFCC">
                        <td height="24" colspan="4"><div align="center">
                            <p><strong><font color="#0000FF" face="Arial, Helvetica, sans-serif">Pulse en el boton a continuacion<br>
              e intente de nuevo </font></strong></p>
                            <p><font color="#FF0000" face="Arial, Helvetica, sans-serif">
                              <input type="submit" name="iniciar2" value="Registrar">
                            </font> </p>
                        </div></td>
                      </tr>
                    </table>
