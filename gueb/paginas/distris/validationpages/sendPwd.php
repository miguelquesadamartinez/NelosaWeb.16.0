...
$result=mysql_query("Select otro From Datas_Tiendas Where mail = '". $emilio ."'" ,$link); 
...
$numi=(string)$row["otro"];
	...
	mail($emilio,"Password www.nelosa.net",$text,"From: <password@nelosa.net>");
?>
          ...
          <table width="100%"  border="0">
            <tr>
              <td height="95" valign="top"><div align="center">
                <p align="center"><font color="#0000FF" size="5" face="Arial, Helvetica, sans-serif">Password enviado a <b><?php echo $usr;?></b></font></p>
                <p align="center"><font color="#0000FF" size="4" face="Arial, Helvetica, sans-serif">En breves minutos recibira su password a la direccion de correo indicada.</font></p>
