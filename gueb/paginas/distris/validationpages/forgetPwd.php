          ...
          <table width="100%"  border="0">
            <tr>
              <td height="95" valign="top"><div align="center">
                <p align="center">&nbsp;</p>
                <p align="center"><font size="5" face="Arial, Helvetica, sans-serif"><strong><font color="#FF0000">Olvido su password </font></strong></font></p>
                <form name="form" id="form" method="post" action="sendPwd.php" onSubmit="return validarDatos()">
                  <div align="center">
                    <p><font color="#0000FF" size="4" face="Arial, Helvetica, sans-serif">Introduzca su email (Usuario) y se le enviara el password en breves instantes.</font></p>
                    <p>
