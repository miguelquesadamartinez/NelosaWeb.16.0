                    ...
                    <div align="center">
                      ...
                      <table border="0">
                        ...
                        <tr>
                          ...
                          <td width="214"><b><font face="Arial, Helvetica, sans-serif">
                            <input type="text" name="hd_nom" id="hd_nombre2" size="35" value="<?php echo htmlentities (  $vs_nombre ) ;?>">
</font></b></td>
  ...
  C/ Velia, 81 - 08016 - Barcelona - Espa&ntilde;a</p>
	...
	<script language='JavaScript' type='text/javascript'>
		...
		function validarDatos(){
			...
			if ( Formulario_2.hd_pob.value=="" ) {
				alert ("Falta Poblacion !!");
				return (false); 
			}
			if ( Formulario_2.hd_empresa.value=="" ) {
				alert ("Falta Nombre de Empresa !!");
				return (false); 
			}
			if ( Formulario_2.hd_adr.value=="" ) {
				alert ("Falta Direccion !!");
				return (false); 
			}
			if ( Formulario_2.hd_tel.value=="" ) {
				alert ("Falta Telefono !!");
				return (false); 
			}
			if ( Formulario_2.hd_doc.value=="" ) {
				alert ("Falta CIF / NIF !!");
				return (false); 
			}
