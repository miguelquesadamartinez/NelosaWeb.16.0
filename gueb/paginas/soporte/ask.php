  ...
  <table width="740" border="0" cellpadding="0" cellspacing="0">
    <tr>
      <td height="141" valign="top" bgcolor="#FFFFFF"><div align="center">
          <p>&nbsp;</p>
          <p>Consulta para Soporte tecnico </p>
            ...
            <tr>
              <td><div align="center">
                  <form name="form1" method="post" action="send.php">
                    <div align="center">
                      <p>email<br>
                          <input name="hd_email" type="text" id="hd_email3" value="<?php echo $vs_email ; ?>" size="45">
                      </p>
                      <p>Asunto<br>
                          <input name="hd_asunto" type="text" id="hd_asunto" size="55">
                      </p>
                      <p>Consulta<br>
                          <textarea name="hd_consulta" cols="55" rows="6" id="hd_consulta"></textarea>
                      </p>
                      <p>
