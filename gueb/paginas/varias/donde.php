            ...
            <table width="100%"  border="0">
              <tr>
                <td height="95" valign="top"><div align="center">
                    <p>&nbsp;</p>
                    <p align="center">Donde estamos</p>
                    <table width="97%"  border="0">
                      <tr>
                        <td><div align="center">
                            <h5>C/ Velia, 81<br> 
                              Fabra y Puig<br>
Barcelona - Espa&ntilde;a</h5>
                            <h5><img src="../../../img/varias/mapas/mapa1.jpg" width="569" height="470"></h5>
                            <p>&nbsp;</p>
                            <p><img src="../../../img/varias/mapas/mapa2.jpg" width="569" height="470"></p>
                            <h5><br>
                            </h5>
                        </div>
                        </td>
