      ...
      <td height="141" valign="top" bgcolor="#FFFFFF"><div align="center">
		...
		?>
          ...
          <table width="654" border="0" align="center">
            ...
            <tr align="center" valign="middle">
              <td bgcolor="#FFFFFF">Su pregunta sera revisada por nuestros tecnicos<br>
              y en breve sera insertada en el foro </td>
            </tr>
            <tr align="center" valign="middle">
...
if ($usr=="") { $usr_tmp = "Anonimo" ; }
			...
			$asunto2 = ereg_replace( " ", "%20", $asunto );
			//$texto2 = ereg_replace( " ", "%20", $texto );

			$filon = "Pregunta de: " . $usr_tmp . "\nAsunto: " . $asunto . "\nPregunta: " . $texto .
			"\nhttp://www.nelosa.net/gueb/paginas/foro/addNew.php?email=" . $usr_tmp . "&asunto=" . $asunto2 . "&texto=" . $texto2  ;
