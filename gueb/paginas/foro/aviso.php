  ...
  <table width="740" border="0" cellpadding="0" cellspacing="0">
    <tr>
      <td height="141" valign="top" bgcolor="#FFFFFF"><div align="center">
          ...
          <form name="form1" method="post" action="aviso-2.php">
...
?>
              ...
              <tr align="center" valign="middle">
                <td><p>Asunto: <?php echo $asunto ; ?><br>
                </p></td>
              </tr>
              <tr align="center" valign="middle">
                <td width="875">&nbsp;</td>
              ...
              <tr align="center" valign="middle">
                <td>email:
                      <?php      	if ($usr == "" ) $nombre = "Anonimo" ;
			else $nombre = $usr ;
?>
                      <input name="emilio" type="text" id="emilio" value="<?php echo $nombre ; ?>">
                      <input name="ind" type="hidden" id="ind" value="<?php echo $indise ?>">
                </td>
              </tr>
              <tr align="center" valign="middle">
                <td>&nbsp;</td>
              ...
              <tr align="center" valign="middle">
                <td><a href="index.php"><img src="../../../img/diseno.paginas/comunes/varias/back.jpg" width="67" height="35" border="0"></a></td>
              </tr>
            </table>
          </form>
          <p align="left">&nbsp; </p>
