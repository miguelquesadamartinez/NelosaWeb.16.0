...
$result=mysql_query("Delete From " . $db . " Where email = '" . $email . "'" ,$link);
 
$result=mysql_query("Insert Into Unsuscribed (email) VALUES('" . $email . "')" ,$link);   
		
?>
</p>
                  <div align="center"></div>
                  <p align="center"><font color="#0000FF" face="Arial, Helvetica, sans-serif"><strong> La direccion de correo electronico <?php echo $email ; ?> ha sido elimidada de nuestra base <BR>
  de datos, e insertada en otra, para que no vuelva a ser utilizada.</strong></font> </p>
