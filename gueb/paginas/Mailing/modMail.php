          ...
          <table width="100%"  border="0">
            <tr>
              <td height="95" valign="top"><div align="center">
                  ...
                  <form name="form1" method="post" action="modMail_2.php">
                    <p align="center"><strong> <font color="#0000FF" face="Arial, Helvetica, sans-serif">Antigua direcci&oacute;n de correo electr&oacute;nico</font></strong></p>
                    <p align="center"><strong><font color="#0000FF" face="Arial, Helvetica, sans-serif">
                      <input name="emailD" type="text" id="emailD" >
                    </font></strong></p>
                    <p align="center"><strong><font color="#0000FF" face="Arial, Helvetica, sans-serif">Nueva direcci&oacute;n de correo electr&oacute;nico</font></strong></p>
                    <p align="center"><strong><font color="#0000FF" face="Arial, Helvetica, sans-serif">
                      <input name="emailI" type="text" id="emailI">
                    </font></strong></p>
                    <p align="center"><strong><font color="#0000FF" face="Arial, Helvetica, sans-serif">
