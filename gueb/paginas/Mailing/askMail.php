          ...
          <table width="100%"  border="0">
            <tr>
              <td height="95" valign="top"><div align="center">
                  ...
                  <form name="form1" method="post" action="Subscribe.php">
                    <p align="center"><font color="#FF0000" face="Arial, Helvetica, sans-serif"><strong>Subscripci&oacute;n Mailing</strong></font></p>
