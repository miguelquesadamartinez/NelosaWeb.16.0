...
<table width="300" border="0" align="center">
  <tr><td height="21"><div align="center"><strong><font color="#FF0000" face="Arial, Helvetica, sans-serif">Mantenimiento 
        Procedimientos DB </font></strong></div></td>
  </tr><tr>
    <td><div align="center">
      <p>
	   </p>
...
<div align="center">
  <table width="732" border="0" align="center">
    <tr>
      <td width="726"><form name="form1" method="post" action="New.php">
        <div align="center">
...
$link = conectarse_param("nelosa_printers") ;
	...
	$result=mysql_query("Select * From Proced Order By Num" ,$link); 
...
while($row = mysql_fetch_array($result)) 
	{ 
		$num=(string)$row["Num"];	
		$proced=(string)$row["Texto"];

		echo "<td><div align='right'><font color='#FF0000' size='2' face='Arial, Helvetica, sans-serif'>" . $num . "</font></div></td>";
		echo "<td><strong><font color='#0000FF' size='2' face='Arial, Helvetica, sans-serif'>" . $proced . "</font></strong></td>";
