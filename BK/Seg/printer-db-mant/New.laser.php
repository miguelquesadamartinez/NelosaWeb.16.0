...
<table width="300" border="0" align="center">
  <tr><td><div align="center"><strong><font color="#FF0000" face="Arial, Helvetica, sans-serif">Mantenimiento
            LASER DB ( new ) <?php echo $Brandy ; ?></font></strong></div></td>
  </tr></table>
<table width="300" border="0" align="center">
  <tr><td>
<?php
...
$link = conectarse_param("nelosa_printers") ;
			...
			echo "Select * From " . $tabla . " Where Printer='" . $textPRN_H . "'";
			...
			if ($bar=="")
			{
				...
				mysql_query("Insert Into " . $tabla . " (Printer,Ins,proced,carga) VALUES ('" . $textPRN_H . "','" . $textINS_H . "','" . $textproced_H . "','" . $textcarga_H . "')",$link);	
				echo "Insert Into " . $tabla . " (Printer,Ins,proced,carga) VALUES ('" . $textPRN_H . "','" . $textINS_H . "','" . $textproced_H . "','" . $textcarga_H . "')" ;
