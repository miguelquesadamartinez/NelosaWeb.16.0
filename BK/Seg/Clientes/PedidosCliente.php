...
<?
require_once("../../../gueb/images/productos/Funciones_PHP.miki");
...
<table width="654" border="1" height="134" align="center">
  <tr>
    <td width="644" height="19"><img src="../../../gueb/images/TitleP.jpg" width="354" height="26"></td>
  </tr>
  <tr> 
    <td width="644" height="39"> 
      <div align="center"> 
        <div align="right"> <font face="Arial, Helvetica, sans-serif" color="#0000FF"> 
          ...
          <p><font face="Arial, Helvetica, sans-serif" color="#0000FF"><a class="AZUL" href="#"><img src="../../../gueb/images/_Back.jpg" width="67" height="35" name="backy" onClick="backyF()" border="0"></a> 
            </font> </p>
        </div>
      </div>
    </td>
...
function backyF ()
{
  ...
  <font color="#0000FF"><b><a class="AZUL" href="" onClick="window.close();"><font size="1">Cerrar 
