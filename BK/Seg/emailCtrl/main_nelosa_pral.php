...
if (isset($nelosa_param))
{
			...
			$result_2=mysql_query("Select * From emails_nelosa_pral Where email = '" . $nelosa_param . "'" ,$link_2); 
			...
			if ($vble_2=="")
			{
				$result_3=mysql_query("Insert Into emails_nelosa_pral (email) VALUES('" . $nelosa_param . "')" ,$link_3); 
