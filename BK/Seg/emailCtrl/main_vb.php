  ...
  <tr>
  	<td width="286">
		<div align="center">
		  ...
		  <p><font face="Arial, Helvetica, sans-serif">Insertados en <strong>emails</strong> DB </font></p>
	    </div>
	</td>
  </tr>
  <tr>
...
if (isset($vb_param))
{
			echo "VB Process con parametro: $vb_param<BR>";
			
			$result_2=mysql_query("Select * From emails Where email = '" . $vb_param . "'" ,$link_2); 
			...
			if ($vble_2=="")
			{
				$result_3=mysql_query("Insert Into emails (email) VALUES('" . $vb_param . "')" ,$link_3); 
				echo $vb_param . " insertado";
				$cnt = -1 ;
			}
			else 
			{
