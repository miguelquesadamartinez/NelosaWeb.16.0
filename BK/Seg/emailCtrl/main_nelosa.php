  ...
  <tr>
  	<td width="286">
		<div align="center">
		  ...
		  <p><font face="Arial, Helvetica, sans-serif">Insertados en <strong>emails_nelosa</strong> DB </font></p>
		</div>
	</td>
  </tr>
  <tr>
...
if (isset($nelosa_param))
{
			...
			$result_2=mysql_query("Select * From emails_nelosa Where email = '" . $nelosa_param . "'" ,$link_2); 
			echo "Select * From emails_nelosa Where email = '" . $nelosa_param . "'<BR>";
			...
			if ($vble_2=="")
			{
				$result_3=mysql_query("Insert Into emails_nelosa (email) VALUES('" . $nelosa_param . "')" ,$link_3); 
				echo "Insert Into emails_nelosa (email) VALUES('" . $nelosa_param . "')<BR>";
